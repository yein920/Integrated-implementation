			...
			<fieldset>
				...
				<div class="form-group">
					<label for="uName">이 름</label> <input type="text"
						class="form-control" id="uName" placeholder="홍길동">
				</div>
				<!-- 성별구분 Start-->
				<!--<div class="btn-group btn-group-toggle" data-toggle="buttons">
            <label class="btn btn-primary">
              <input type="radio" name="u" id="option1" autocomplete="off" checked=""> Active
            </label>
            <label class="btn btn-primary">
              <input type="radio" name="options" id="option2" autocomplete="off"> Radio
				...
				<div class="box">
					<div id="join1-button">
						<form action="#" method="get">
							<button type="button" class="btn-secondary"
								onclick="location.href='#.jsp'">회 원 가 입</button>
						</form>
					</div>
					<div id="join2-button">
						<form action="#" method="get">
							<button type="button" class="btn-secondary"
								onclick="location.href='#.jsp'">전문가로 가입하기</button>
						</form>
					</div>
				</div>
			</fieldset>
