  ...
  <!--modalEnd-->
        ...
        <main id="main">
            <section id="visual" class="clearfix">
                <p>수리! 청소! 이사!</p>
                <p><span>혼자사는 당신</span>을 위한 <span>전문가</span>를 소개해드립니다.</p>
                <button type="button" id="heayo" class="heayo_btn" data-toggle="modal" data-target="#exampleModalCenter">전문가 견적받기</button>
